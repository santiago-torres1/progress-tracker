...
/**
 * A few plain counts about this account, for the profile page.
 *
 ...
 *
 * All of them are computed by the backend in the caller's own time zone where a day is involved;
 * nothing in the frontend derives one.
 */
